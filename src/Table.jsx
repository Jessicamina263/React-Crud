...
export default function Table({ products, onEdit, onDelete }) {
    return (
        <div id="tablecontainer" style={{ marginLeft: 250, marginTop: 50 }}>
            <table>
                <thead>
                    <tr>
                        <th>Index</th>
                ...
                <tbody>
                    {products.length === 0 ? (
                        <tr>
                            <td colSpan="7">No Data at all</td>
                        </tr>
                    ) : (
                                ...
                                <td>
                                    ...
                                    >
                                        <svg
                                            ...
                                            viewBox="0 0 512 512"
                                            style={{ fill: 'green', width: '24px', height: '24px', transition: 'fill 0.3s' }}
                                ...
                                <td>
                                    ...
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 448 512"
                                            style={{ fill: 'red', width: '24px', height: '24px', transition: 'fill 0.3s' }}
